...
def get_model(name="resnet"):
    model = torch.hub.load('pytorch/vision:v0.10.0', 'resnet50', pretrained=True)  # test 50
...
if __name__ == '__main__':
    ...
    if mode == 'train':
        ...
        if m == "new":
            ...
            print(f"{len(set(train_dataset.labels)), min(train_dataset.labels), max(train_dataset.labels)}")
