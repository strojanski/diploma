...
data_train = UERCDataset(
    "train",
    DATA_BASE_PATH,
    "../data/public_annotations.csv",
    "../runs/public_image_list.csv",
    data_splits_csv="../runs/train_val_test_splits.csv",
)
data_val = UERCDataset(
    "val",
    DATA_BASE_PATH,
    "../data/public_annotations.csv",
    "../runs/public_image_list.csv",
...
optimizer = optim.Adam(
    model.parameters(), lr=0.0001, weight_decay=0.001, betas=(0.8, 0.999), eps=1e-08
)
